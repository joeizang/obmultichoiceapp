    ...
    <>
      <Card>
        <CardHeader color="primary">
          <CardTitle className="text-center font-weight-bold"><h3>Create Category</h3></CardTitle>
        </CardHeader>
        <CardBody>
          <Form onSubmit={handleSubmit(async (data) => {
            const temp = await axios.post('https://localhost:5001/api/categories', data);
            ...
            <FormGroup>
              ...
              <Input
                ...
                innerRef={register({ required: true, maxLength: 50, minLength: 2 })}
              />
            </FormGroup>
